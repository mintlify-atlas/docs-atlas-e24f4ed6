...
<Note>
  `SimpleListener` is automatically registered by Foundation when annotated with `@AutoRegister`. See the [listeners guide](/core-concepts/listeners) for more details.
</Note>
